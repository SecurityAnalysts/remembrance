NTSTATUS_CODES = [(0x0, "STATUS_SUCCESS", "The operation completed successfully"),
                  (0x0, "STATUS_WAIT_0", "The caller specified WaitAny for WaitType and one of the dispatcher objects in the Object array has been set to the signaled state"),
                  (0x1, "STATUS_WAIT_1", "The caller specified WaitAny for WaitType and one of the dispatcher objects in the Object array has been set to the signaled state"),
                  (0x2, "STATUS_WAIT_2", "The caller specified WaitAny for WaitType and one of the dispatcher objects in the Object array has been set to the signaled state"),
                  (0x3, "STATUS_WAIT_3", "The caller specified WaitAny for WaitType and one of the dispatcher objects in the Object array has been set to the signaled state"),
                  (0x3f, "STATUS_WAIT_63", "The caller specified WaitAny for WaitType and one of the dispatcher objects in the Object array has been set to the signaled state"),
                  (0x80, "STATUS_ABANDONED", "The caller attempted to wait for a mutex that has been abandoned"),
                  (0x80, "STATUS_ABANDONED_WAIT_0", "The caller attempted to wait for a mutex that has been abandoned"),
                  (0xbf, "STATUS_ABANDONED_WAIT_63", "The caller attempted to wait for a mutex that has been abandoned"),
                  (0xc0, "STATUS_USER_APC", "A user-mode APC was delivered before the given Interval expired"),
                  (0x101, "STATUS_ALERTED", "The delay completed because the thread was alerted"),
                  (0x102, "STATUS_TIMEOUT", "The given Timeout interval expired"),
                  (0x103, "STATUS_PENDING", "The operation that was requested is pending completion"),
                  (0x104, "STATUS_REPARSE", "A reparse should be performed by the Object Manager because the name of the file resulted in a symbolic link"),
                  (0x105, "STATUS_MORE_ENTRIES", "Returned by enumeration APIs to indicate more information is available to successive calls"),
                  (0x106, "STATUS_NOT_ALL_ASSIGNED", "Indicates not all privileges or groups that are referenced are assigned to the caller. This allows, for example, all privileges to be disabled without having to know exactly which privileges are assigned"),
                  (0x107, "STATUS_SOME_NOT_MAPPED", "Some of the information to be translated has not been translated"),
                  (0x108, "STATUS_OPLOCK_BREAK_IN_PROGRESS", "An open/create operation completed while an opportunistic lock (oplock) break is underway"),
                  (0x109, "STATUS_VOLUME_MOUNTED", "A new volume has been mounted by a file system"),
                  (0x10a, "STATUS_RXACT_COMMITTED", "This success level status indicates that the transaction state already exists for the registry subtree but that a transaction commit was previously aborted. The commit has now been completed"),
                  (0x10b, "STATUS_NOTIFY_CLEANUP", "Indicates that a notify change request has been completed due to closing the handle that made the notify change request"),
                  (0x10c, "STATUS_NOTIFY_ENUM_DIR", "Indicates that a notify change request is being completed and that the information is not being returned in the caller's buffer. The caller now needs to enumerate the files to find the changes"),
                  (0x10d, "STATUS_NO_QUOTAS_FOR_ACCOUNT", "{No Quotas} No system quota limits are specifically set for this account"),
                  (0x10e, "STATUS_PRIMARY_TRANSPORT_CONNECT_FAILED", "{Connect Failure on Primary Transport} An attempt was made to connect to the remote server %hs on the primary transport, but the connection failed. The computer WAS able to connect on a secondary transport"),
                  (0x110, "STATUS_PAGE_FAULT_TRANSITION", "The page fault was a transition fault"),
                  (0x111, "STATUS_PAGE_FAULT_DEMAND_ZERO", "The page fault was a demand zero fault"),
                  (0x112, "STATUS_PAGE_FAULT_COPY_ON_WRITE", "The page fault was a demand zero fault"),
                  (0x113, "STATUS_PAGE_FAULT_GUARD_PAGE", "The page fault was a demand zero fault"),
                  (0x114, "STATUS_PAGE_FAULT_PAGING_FILE", "The page fault was satisfied by reading from a secondary storage device"),
                  (0x115, "STATUS_CACHE_PAGE_LOCKED", "The cached page was locked during operation"),
                  (0x116, "STATUS_CRASH_DUMP", "The crash dump exists in a paging file"),
                  (0x117, "STATUS_BUFFER_ALL_ZEROS", "The specified buffer contains all zeros"),
                  (0x118, "STATUS_REPARSE_OBJECT", "A reparse should be performed by the Object Manager because the name of the file resulted in a symbolic link"),
                  (0x119, "STATUS_RESOURCE_REQUIREMENTS_CHANGED", "The device has succeeded a query-stop and its resource requirements have changed"),
                  (0x120, "STATUS_TRANSLATION_COMPLETE", "The translator has translated these resources into the global space and no additional translations should be performed"),
                  (0x121, "STATUS_DS_MEMBERSHIP_EVALUATED_LOCALLY", "The directory service evaluated group memberships locally, because it was unable to contact a global catalog server"),
                  ...
                  (0x126, "STATUS_FSFILTER_OP_COMPLETED_SUCCESSFULLY", "A file system or file system filter driver has successfully completed an FsFilter operation"),
                  (0x127, "STATUS_INTERRUPT_VECTOR_ALREADY_CONNECTED", "The specified interrupt vector was already connected"),
                  (0x128, "STATUS_INTERRUPT_STILL_CONNECTED", "The specified interrupt vector is still connected"),
                  (0x129, "STATUS_PROCESS_CLONED", "The current process is a cloned process"),
                  (0x12a, "STATUS_FILE_LOCKED_WITH_ONLY_READERS", "The file was locked and all users of the file can only read"),
                  (0x12b, "STATUS_FILE_LOCKED_WITH_WRITERS", "The file was locked and at least one user of the file can write"),
                  (0x202, "STATUS_RESOURCEMANAGER_READ_ONLY", "The specified ResourceManager made no changes or updates to the resource under this transaction"),
                  (0x367, "STATUS_WAIT_FOR_OPLOCK", "An operation is blocked and waiting for an oplock"),
                  (0x10001, "DBG_EXCEPTION_HANDLED", "Debugger handled the exception"),
                  (0x10002, "DBG_CONTINUE", "The debugger continued"),
                  ...
                  (0x40000015, "STATUS_FATAL_APP_EXIT", "{Fatal Application Exit} %h"),
                  ...
                  (0x40000018, "STATUS_SERVICE_NOTIFICATION", "%h"),
                  (0x40000019, "STATUS_WAS_LOCKED", "{Page Locked} One of the pages to lock was already locked"),
                  (0x4000001a, "STATUS_LOG_HARD_ERROR", "Application popup: %1 : %"),
                  ...
                  (0xc000a2a3, "STATUS_OFFLOAD_READ_FILE_NOT_SUPPORTED", "Offload read operations cannot be performed on: Compressed files Sparse files Encrypted files File system metadata file"),
                  (0xc000a2a4, "STATUS_OFFLOAD_WRITE_FILE_NOT_SUPPORTED", "Offload write operations cannot be performed on: Compressed files Sparse files Encrypted files File system metadata file"),
                  ...
                  (0xc0040039, "STATUS_IO_REISSUE_AS_CACHED", "Reissue the given operation as a cached I/O operatio"),
                  ...
                  (0xc01e000c, "STATUS_GRAPHICS_PRESENT_UNOCCLUDED", "Previous exclusive VidPn source owner has released its ownershi"),
